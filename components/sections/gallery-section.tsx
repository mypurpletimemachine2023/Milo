...
export function GallerySection() {
  ...
  const images = [
    { src: "/images/eagles-tees.jpg", alt: "Custom Fly Eagles Fly sports shirts" },
    { src: "/images/deadpool-tee.jpg", alt: "Custom Maximum Effort character tee" },
    { src: "/images/work-shirt.jpg", alt: "Restaurant work uniform shirts" },
    { src: "/images/team-red.jpg", alt: "Surge Football team in custom red shirts" },
  ];

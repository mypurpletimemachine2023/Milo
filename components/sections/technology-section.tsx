...
const sideImages = [
  {
    src: "/images/business-shirts.jpg",
    alt: "Business work uniforms with heat press",
    position: "left",
  },
  {
    src: "/images/night-game.jpg",
    alt: "Team jerseys in action at night game",
    position: "right",
  },
];
...
export function TechnologySection() {
  ...
  const descriptionText = "Custom logo design services, mockups, jersey sets for sports teams, work uniforms, and custom birthday party shirts. From single orders to full team kits. We bring your ideas to life.";
        ...
        <div className="flex h-full w-full items-center justify-center">
          ...
          >
            ...
            >
              ...
              {/* Image 2 - Boxing theme tee */}
              <Image
                src="/images/boxing-tee.jpg"
                alt="Custom boxing themed shirt"
                fill
              ...
              {/* Image 3 - Eagles sports tees */}
              <Image
                src="/images/eagles-tees.jpg"
                alt="Fly Eagles Fly custom shirts"
                fill
                className="absolute inset-0 object-cover"
                style={{
              ...
              {/* Image 4 - Team red photo */}
              <Image
                src="/images/team-red.jpg"
                alt="Surge team in matching red shirts"
                fill
                className="absolute inset-0 object-cover"
                style={{
              ...
              {/* Image 2 - Team uniforms display */}
              <Image
                src="/images/uniforms-display-1.jpg"
                alt="Team uniforms and athletic wear"
                fill
                className="absolute inset-0 object-cover"
                style={{
                  opacity: Math.max(0, Math.min(1, (scrollProgress - 0.1) / 0.2)),
              ...
              {/* Image 3 - Team jerseys with custom designs */}
              <Image
                src="/images/team-jerseys.jpg"
                alt="Hooded jerseys with custom designs"
                fill
                className="absolute inset-0 object-cover"
                style={{
                  opacity: Math.max(0, Math.min(1, (scrollProgress - 0.4) / 0.2)),
              ...
              {/* Image 4 - Team photo in action */}
              <Image
                src="/images/team-photo.jpg"
                alt="Team wearing custom shirts"
                fill
                className="absolute inset-0 object-cover"
                style={{
                  opacity: Math.max(0, Math.min(1, (scrollProgress - 0.7) / 0.2)),

...
const sideImages = [
  {
    src: "/images/surge-tee.jpg",
    alt: "Custom team logo shirt",
    position: "left",
    span: 1,
  },
  {
    src: "/images/berserk-tee.jpg",
    alt: "Anime character print shirt",
    position: "left",
    span: 1,
  },
  {
    src: "/images/wonder-woman-tee.jpg",
    alt: "Custom artwork shirt",
    position: "right",
    span: 1,
  },
  {
    src: "/images/ballhawks-tee.jpg",
    alt: "Sports team custom shirt",
    position: "right",
    span: 1,
  },
];
        ...
        <div className="flex h-full w-full items-center justify-center">
          ...
          >
            ...
            >
              ...
              <div className="absolute inset-0 z-10 bg-black/30" style={{ opacity: textOpacity }} />
              
              {/* Big COQUI Text - In front of image */}
              <div 
                className="absolute inset-0 z-20 flex items-center justify-center"
                style={{ opacity: textOpacity }}
              >
                <h1 className="whitespace-nowrap text-[30vw] font-bold leading-[0.8] tracking-tighter text-white drop-shadow-2xl">

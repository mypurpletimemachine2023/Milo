...
const specs = [
  { label: "Custom Tees", value: "$20+", color: "text-coqui-blue" },
  { label: "Logo Design", value: "Custom", color: "text-coqui-red" },
  { label: "Turnaround", value: "3-5 Days", color: "text-coqui-blue" },
  { label: "Team Orders", value: "Bulk", color: "text-coqui-red" },
];
      ...
      <div className="grid grid-cols-2 border-t border-border md:grid-cols-4">
        {specs.map((spec) => (
          ...
          >
            ...
            <p className={`font-medium text-5xl ${spec.color}`}>
              {spec.value}
            </p>
          </div>
        ))}

...
const titles = [
  { text: "Logo Design.", color: "text-coqui-blue" },
  { text: "Jersey Sets.", color: "text-coqui-red" },
  { text: "Team Uniforms.", color: "text-foreground" },
];
              ...
              <div className="relative w-full" style={{ transformStyle: 'preserve-3d', minHeight: '150px' }}>
                {titles.map((titleObj, index) => {
                  ...
                  return (
                    <h2 
                      key={index}
                      className={`absolute inset-0 flex items-center justify-center text-[8vw] sm:text-[7vw] font-medium leading-tight tracking-tighter md:text-[6vw] lg:text-[5vw] text-center px-4 ${titleObj.color}`}
                      style={{
      ...
      <div ref={descriptionRef} className="px-6 pt-8 pb-20 md:px-12 md:pt-12 md:pb-28 lg:px-20 lg:pt-16 lg:pb-36">
        <div className="text-center">
          ...
          <p className="mt-8 leading-relaxed text-muted-foreground text-3xl text-center">
            {("We do custom logo design, mockups, jersey sets for sports teams, work uniforms, and custom birthday party shirts. Professional quality with fast turnaround.").split(" ").map((word, index, array) => {
